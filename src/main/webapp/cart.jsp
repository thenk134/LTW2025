            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
						...
						if(khachHang==null){
						%>
						<a href="login.jsp">Guest <span class="cart-amunt"></span>
						<i class="glyphicon glyphicon-user"></i></a>
						<%} else { %>
						<div class="row text-left" style="margin-left: 0.25em">
							<div class="col"><b><%= khachHang.getTendangnnhap() %></b> <a style="white-space: nowrap;" href="dangxuat">Logout</a>
					...
					<div class="shopping-item">
						<a href="cart.jsp">Cart <span class="cart-amunt"></span> 
                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            ...
                            <h2><a href="single-product.jsp">Xiaomi 11T 5G 128GB</a></h2>
                        ...
                        <div class="thubmnail-recent">
                            ...
                            <h2><a href="single-product.jsp"> Samsung Galaxy A52s 5G</a></h2>
                            <div class="product-sidebar-price">
                        ...
                        <div class="thubmnail-recent">
                            ...
                            <h2><a href="single-product.jsp">Apple Watch SE 40mm</a></h2>
                            <div class="product-sidebar-price">
                        ...
                        <div class="thubmnail-recent">
                            ...
                            <h2><a href="single-product.jsp">Xmobile P68D </a></h2>
                            <div class="product-sidebar-price">
                        ...
                        <div class="thubmnail-recent">
                            ...
                            <h2><a href="single-product.jsp">Samsung Galaxy Tab S7 FE</a></h2>
                            <div class="product-sidebar-price">
                    ...
                    <div class="single-sidebar">
                        ...
                        <ul>
                            <li><a href="single-product.jsp">Laptop Acer Nitro 5 Gaming AN515 57 727J i7 11800H/8GB/512GB/4GB</a></li>
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.jsp"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="img/xiaomi.jpg"></a>
                                            </td>
                                            ...
                                            <td class="product-price">
                                                <span class="amount">10.390.000</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="actions" colspan="6">
                                                <div class="coupon">
                                                    ...
                                                    <input style="width: auto;" type="text" placeholder="Coupon code" value="" id="coupon_code" class="input-text" name="coupon_code">
                                    ...
                                    <ul class="products">
                                        <li class="product">
                                            <a href="single-product.jsp">
                                                ...
                                                <span class="price"><span class="amount">30.990.000</span></span>
                                            </a>
                                        ...
                                        <li class="product">
                                            <a href="single-product.jsp">
                                                ...
                                                <h3>Samsung Galaxy Z</h3>
                                                <span class="price"><span class="amount">16.490.000</span></span>
                                            </a>
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                <th>Cart subtotal</th>
                                                <td><span class="amount">10.390.000 Ä</span></td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Order total</th>
                                                <td><strong><span class="amount">10.390.000 Ä</span></strong> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
