...
<body>
	...
	<% 
		...
		tendangnhap = (baoLoi.equals("null"))?"":tendangnhap;
		
		String tenkhachhang= request.getAttribute("tenkhachhang")+ "";
		tenkhachhang = (baoLoi.equals("null"))?"":tenkhachhang;
		
		String email= request.getAttribute("email")+"";
		email = (baoLoi.equals("null"))?"":email;
	%>
		<div class="inner-box">
			<form action="dang-nhap" method="post">
				...
				<input style="font-size: 17px;" type="text" name="tendangnhap"
					placeholder="User name" required /> <input style="font-size: 17px;"
					type="password" name="matkhau" placeholder="Password" required />
