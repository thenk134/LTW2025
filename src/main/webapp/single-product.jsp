                            ...
                            <div class="related-products-carousel">
                                <div class="single-product">
                                    ...
                                    <div class="product-carousel-price">
                                        <ins>5.999.000 Ä</ins> <del>6.649.000 Ä</del>
                                    </div>
                                </div>
                                <div class="single-product">
                                    <div class="product-f-image">
                                    ...
                                    <div class="product-carousel-price">
                                        <ins>30.990.000 Ä</ins> <del>33.999.000 Ä</del>
                                    </div>
                                </div>
                                <div class="single-product">
                                    <div class="product-f-image">
                                    ...
                                    <div class="product-carousel-price">
                                        <ins>39.999.999 Ä</ins> <del>43.990.000 Ä</del>
                                    </div>
                                </div>
                                <div class="single-product">
                                    <div class="product-f-image">
                                    ...
                                    <div class="product-carousel-price">
                                        <ins>20.900.000 Ä</ins> <del>24.980.000 Ä</del>
                                    </div>
                                </div>
                                <div class="single-product">
                                    <div class="product-f-image">
                                    ...
                                    <div class="product-carousel-price">
                                        <ins>4.999.990 Ä</ins> <del>6.700.000 Ä</del>
                                    </div>
                                </div>
                                <div class="single-product">
                                    <div class="product-f-image">
                                    ...
                                    <div class="product-carousel-price">
                                        <ins>17.220.000 Ä</ins> <del>19.980.000 Ä</del>
                                    </div>
                                </div>
                            </div>
                        </div>
