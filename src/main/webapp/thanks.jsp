...
<body>
    ...
    <div class="box">
		...
		<p style="text-align:center;" >
            <h4 style="text-align:center;">Thank you for creating an account.</h4></p>
            <p style="text-align:center;" > We send varification link on your providing email address please confrom your email address.</p>
		
		<p style="text-align:center;" >
				<a class="link" href="login.jsp">Sign In Now</a>
		</p>
